...
const schemaPath = join(__dirname$1, '..', 'schema', 'esm-schema.json');
let schema;
let validator;
try {
...
export { ParseError, SCHEMA_VERSION, SchemaValidationError, VERSION, componentExists, component_graph, contains, evaluate, freeParameters, freeVariables, getComponentType, load, save, simplify, substitute, substituteInModel, substituteInReactionSystem, toAscii, toLatex, toUnicode, validate, validateSchema };
